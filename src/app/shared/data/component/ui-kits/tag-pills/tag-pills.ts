...
export const pills: button[] = [
  {
    ...
    title:
      ' Use the <code>.rounded-pill</code> utility class to make badges more rounded with a larger <code>border-radius</code>.</p> ',
    item: [
      {
...
export const NumberPillstag: button[] = [
  {
    ...
    title:
      ' Use the <code>.rounded-circle</code> utility class to make badges more rounded with a larger <code>border-radius</code>.',
    item: [
      {
...
export const iconpills: button[] = [
  {
    ...
    title:
      'Use the <code>.rounded-pill</code> utility class to make icons badges more rounded with a larger <code>border-radius</code>.',
    item: [
      {
