...
export const allData: all[] = [
  ...
  },
  {
    ...
    desc: 'boho introduces a ielts coaching, toefl coaching, gre coaching, gmat coaching, sat coaching in surat.',
    rating: 3,
    votes: 590,
    type: 'Theme',
    showRating: true,
...
export const videosData: video[] = [
  {
    ...
    data: [
      ...
      },
      {
        ...
        title: 'Cion introduces a IELTS Coaching, TOEFL Coaching, GRE Coaching.',
        rating: 3,
        votes: 590,
        type: 'Theme',
      },
