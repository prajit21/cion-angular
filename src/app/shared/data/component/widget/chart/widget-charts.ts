import {
  ...
  LiveProductChart,
  TurnOverCharts,
  CryptoCurrencyPriceChart,
  CryptoAnnotationChart,
  StockMarketChart,
  FinanceChart,
  OrderStatusChart2,
  MonthlySalesChart,
  UsersChart,
  SkillStatusChart,
  ProgressChartOptions1,
  ProgressChartOptions2,
  ProgressChartOptions3,
  ProgressChartOptions4,
  ProgressChartOptions5,
  TotalChartOptions,
...
export const TotalSale: TotalChartOptions = {
  chart: {
    toolbar: {
      show: false,
    },
...
export const TotalProject: TotalChartOptions = {
  chart: {
    toolbar: {
      show: false,
    },
...
export const TotalProduct: TotalChartOptions = {
  chart: {
    toolbar: {
      show: false,
    },
...
export const MonthlyHistory: MonthlyHistoryChart = {
  series: [
    {
      name: 'Profit',
  ...
  colors: [secondary_color, '#63d5be', primary_color],
  fill: {
    type: 'gradient',
    gradient: {
      shade: 'light',
...
export const skillStatus: SkillStatusChart = {
  chart: {
    type: 'radialBar',
    height: 375,
    offsetY: -30,
  ...
  colors: [secondary_color, primary_color, '#63d5be'],
  responsive: [
    {
      breakpoint: 767,
      options: {
...
export const liveproducts: LiveProductChart = {
  chart: {
    height: 320,
    type: 'area',
    toolbar: {
...
export const Progress1: ProgressChartOptions1 = {
  chart: {
    height: 70,
    type: 'bar',
    stacked: true,
  ...
  dataLabels: {
    enabled: false, // 👈 added to satisfy interface
  },
  grid: {
    show: false, // 👈 added to satisfy interface
  },
  title: {
    floating: true,
    offsetX: -10,
...
export const Progress2: ProgressChartOptions2 = {
  chart: {
    height: 70,
    type: 'bar',
    stacked: true,
...
export const Progress3: ProgressChartOptions3 = {
  chart: {
    height: 70,
    type: 'bar',
    stacked: true,
...
export const Progress4: ProgressChartOptions4 = {
  chart: {
    height: 70,
    type: 'bar',
    stacked: true,
...
export const Progress5: ProgressChartOptions5 = {
  chart: {
    height: 70,
    type: 'bar',
    stacked: true,
...
export const TrunOverchat: TurnOverCharts = {
  chart: {
    toolbar: {
      show: false,
    },
...
export const CryptocurrencyPrices: CryptoCurrencyPriceChart = {
  chart: {
    toolbar: {
      show: false,
    },
...
export const cryptochart: CryptoAnnotationChart = {
  series: [
    {
...
export const stockMarketchart: StockMarketChart = {
  series: [
    {
      name: 'line',
      type: 'line',
...
export const Financeschart: FinanceChart = {
  chart: {
    height: 350,
    type: 'line',
...
export const orderStatuschart: OrderStatusChart2 = {
  chart: {
    height: 350,
    type: 'line',
    stacked: true,
...
export const monthlySales: MonthlySalesChart = {
  fill: {
    type: 'gradient',
    gradient: {
      shade: 'dark',
...
export const UserChart: UsersChart = {
  chart: {
    toolbar: {
      show: false,
    },
  ...
  colors: [primary_color, secondary_color, '#63d5be', '#544fff'],
  title: {
