...
export let areaSpalineChart: AreaSpalineChart = {
  chart: {
    height: 350,
    type: 'area',
    toolbar: {
...
export let barChart: BarChartConfig = {
  chart: {
    height: 350,
    type: 'bar',
    toolbar: {
...
export let donutChart: DonutChart = {
  chart: {
    width: 380,
    type: 'donut',
  },
...
export let mixedChart: MixChart = {
  chart: {
    height: 350,
    type: 'line',
    stacked: false,
...
// Radar Chart
export let candlestickChart: CandleStickChart = {
  chart: {
    height: 350,
    type: 'candlestick',
    toolbar: {
