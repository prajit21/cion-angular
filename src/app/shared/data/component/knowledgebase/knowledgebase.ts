...
export const knowledgebaseData: knowledgebase[] = [
  {
    title: 'Articles',
    colClass: '',
    desc: 'How little experience or technical knowledge you currently have. The web is a very big place, and if you the typical internet user, you probably visit several websites every day.',
    icon: 'book-open',
  },
  {
    title: 'Knowledgebase',
